...
class OutputsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create output" do
    assert_difference('Output.count') do
      post outputs_url, params: { output: { date: @output.date, float: @output.float, int: @output.int, string: @output.string, text: @output.text, tinyint: @output.tinyint } }
    end
  ...
  test "should update output" do
    patch output_url(@output), params: { output: { date: @output.date, float: @output.float, int: @output.int, string: @output.string, text: @output.text, tinyint: @output.tinyint } }
